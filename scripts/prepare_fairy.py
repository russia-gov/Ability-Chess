...
(dest / "UPSTREAM_INTEGRATION_STATUS.txt").write_text(
    "AbilityFish kernel installed; Position, null-search turn synchronization, frozen attacks, Ambush, Portal routing, post-effect legality, type-wide upgrade movement, recursive search, root transport, and UCI hooks applied.\n"
)

...
(dest / "UPSTREAM_INTEGRATION_STATUS.txt").write_text(
    "AbilityFish kernel installed; Position, null-search turn synchronization, ability castling-state synchronization, frozen attacks, Ambush, Portal routing, post-effect legality, type-wide upgrade movement, recursive search, root transport, and UCI hooks applied.\n"
)

for script in (
    "apply_fairy_position_hooks.py",
    "apply_fairy_null_move_hooks.py",
    "apply_fairy_castling_state_hooks.py",
